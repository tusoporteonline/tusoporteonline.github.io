/*
 * AllInOne Banner - Carousel v3.6.0
 *
...
(function($) {
	...
	function allinone_carousel_navigation(direction,options,current_obj,bottomNavButs,imgs,allinone_carousel_container,total_images,allinone_carousel_playOver,allinone_carousel_elementTitle){
			...
			animateDiv (current_obj.currentImg,new_left,new_top,new_width,new_height,1,false,direction,current_obj,options,allinone_carousel_elementTitle,imgs,total_images,allinone_carousel_playOver,bottomNavButs,allinone_carousel_container,true);
			...
			for (m=1;m<=Math.floor(options.numberOfVisibleItems/2);m++){
				...
				if (m==Math.floor(options.numberOfVisibleItems/2)) {
					if (direction===1) {
						...
						animateDiv (last_currentImg,new_left,new_top,new_width,new_height,0,false,direction,current_obj,options,allinone_carousel_elementTitle,imgs,total_images,allinone_carousel_playOver,bottomNavButs,allinone_carousel_container,false);
					} else { //direction=-1
						new_height=options.contentHolderUnitOrigHeight/(options.origWidth/options.width)-2*(m+1)*options.elementsVerticalSpacing/(options.origWidth/options.width);
						new_width=parseInt(new_height * current_obj.aspectOrig,10);
				...
				animateDiv (current_obj.currentImg,new_left,new_top,new_width,new_height,1,false,direction,current_obj,options,allinone_carousel_elementTitle,imgs,total_images,allinone_carousel_playOver,bottomNavButs,allinone_carousel_container,false);
			...
			for (m=1;m<=Math.floor(options.numberOfVisibleItems/2);m++){
				...
				if (m==Math.floor(options.numberOfVisibleItems/2))
					animateDiv (current_obj.currentImg,new_left,new_top,new_width,new_height,1,true,direction,current_obj,options,allinone_carousel_elementTitle,imgs,total_images,allinone_carousel_playOver,bottomNavButs,allinone_carousel_container,false);
				else
					animateDiv (current_obj.currentImg,new_left,new_top,new_width,new_height,1,false,direction,current_obj,options,allinone_carousel_elementTitle,imgs,total_images,allinone_carousel_playOver,bottomNavButs,allinone_carousel_container,false);
	...
	function animateDiv (the_div,new_left,new_top,new_width,new_height,new_opacity,autoplay_next,direction,current_obj,options,allinone_carousel_elementTitle,imgs,total_images,allinone_carousel_playOver,bottomNavButs,allinone_carousel_container,isTheFrontOne) {
		current_obj.slideIsRunning=true;
		/*3.5.1 start*/
		if (isTheFrontOne==false && options.activeItemClass!='') {
				the_div.removeClass(options.activeItemClass);
		}
		/*3.5.1 end*/
		// the title
		...
		the_div.animate({
		    ...
		    // Animation complete.
				/*3.5.1 start*/
				if (isTheFrontOne==true && options.activeItemClass!='') {
						the_div.addClass(options.activeItemClass);
				}
				/*3.5.1 end*/
	...
	$.fn.allinone_carousel = function(options) {
		...
		return this.each(function() {
	            	...
	            	if (total_images==1) {
			            		contentHolderUnit.css({
											...
											if (options.activeItemClass!='')
													contentHolderUnit.addClass(options.activeItemClass);
											/* 3.5.1 end */
			            		if ($(imgs[current_obj.current_img_no]).attr('data-video')=='true')
			            				allinone_carousel_playOver.css('display','block');
	            	} else {
			...
			//pause on hover
			allinone_carousel_container.on( "mouseenter", function() {
			...
			allinone_carousel_container.on( "mouseleave", function() {
			...
			allinone_carousel_playOver.on( "click", function() {
					if (options.showCircleTimer) {
						$('.mycanvas',allinone_carousel_container).css({
							'display':'none'
						});
			...
			//controllers
			allinone_carousel_leftNav.on( "click", function() {
				arrowClicked=true;
				if (!current_obj.slideIsRunning && !current_obj.fastForwardRunning) {
					//current_obj.mouseOverBanner=false;
					current_obj.isVideoPlaying=false;
			...
			allinone_carousel_leftNav.on( "mouseout", function() {
				arrowClicked=false;
			});
			allinone_carousel_rightNav.on( "click", function() {
				arrowClicked=true;
				if (!current_obj.slideIsRunning && !current_obj.fastForwardRunning) {
					//current_obj.mouseOverBanner=false;
					current_obj.isVideoPlaying=false;
			...
			allinone_carousel_rightNav.on( "mouseout", function() {
				arrowClicked=false;
			});
			...
			bottomNavButs.on( "mouseout", function() {
				arrowClicked=false;
			});
			...
			if (options.enableTouchScreen) {
				allinone_carousel_container.swipe({
